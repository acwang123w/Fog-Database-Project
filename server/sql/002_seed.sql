...
INSERT INTO users (email, password_hash, country, friend_code, account_balance) VALUES
 ('alice@example.com', '$2b$10$dummydummydummydummydummy111', 'US', 'ALC-123', 50),
 ('bob@example.com',   '$2b$10$dummydummydummydummydummy222', 'US', 'BOB-456', 20),
 ('cara@example.com',  '$2b$10$dummydummydummydummydummy333', 'CA', 'CAR-789', 10);
...
INSERT INTO awards (name, category, year) VALUES
 ('Steam Awards','Game of the Year',2023),
 ('Steam Awards','Labor of Love',2023);
